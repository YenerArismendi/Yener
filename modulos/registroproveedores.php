...
if(!empty($_POST["guardarProveedores"])){   
    if(empty($_POST["nombre-proveedor"]) or empty($_POST["identificacion-proveedor"]) or empty($_POST["telefono-celular"]) or empty($_POST["telefono-fijo"]) 
        or empty($_POST["correo-proveedor"]) or empty("ciudad-proveedor") or empty($_POST["direccion-proveedor"]) or empty($_POST["barrio-proveedor"]) or empty($_POST["descripcion-proveedor"])){
        ...
        ('$NombreProveedores', '$IdentificacionProveedores', '$TelefonoCelular', '$TelefonoFijo', '$CorreoProveedores', '$CiudadProveedores', '$DireccionProveedor',
        '$BarrioProveedor', '$DescripcionProveedor')");
